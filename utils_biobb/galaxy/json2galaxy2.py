...
def main():
    """ Usage: json2galaxy.py [-h] [--template TEMPLATE] [--xml_dir XML_DIR]
        ...
        optional arguments:
            ...
            * --xml_dir (**str**) Path to dorectory to place XML output files. 
    ...
    parser.add_argument(dest="schema", help="Json schema from building blocks group")
    ...
    base_path = os.path.dirname(args.schema)
