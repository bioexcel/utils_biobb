...
def main():
    try:
        ...
        if type == "j":
            ...
            print(f"📂 All the data generated by the workflow will be stored in the new {wd}/wf_notebook folder")
            ...
            print(f"📂 All the data generated by the workflow will be stored in the new {wd}/wf_python folder")
